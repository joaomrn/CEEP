...
public class ListaNotasActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(ehResultadoAlteraNota(requestCode,data)){
            if(resultadoOk(resultCode)){
                ...
                if(enPosicaoValida(posicaoRecebida)){
    ...
    private boolean enPosicaoValida(int posicaoRecebida) {
    ...
    private void configurarRecyclerView(List<Nota> todasNotas) {
        ...
        configuraItemTochHelper(listaNotas);
    }

    private void configuraItemTochHelper(RecyclerView listaNotas) {
    ...
    private void configuraAdapter(List<Nota> todasNotas, RecyclerView listaNotas) {
        ...
        adapter.setOnItemClickListener((nota, posicao) -> vaiParaFormularioNotaActivityAlterada(nota, posicao));
    }

    private void vaiParaFormularioNotaActivityAlterada(Nota nota, int posicao) {
